...
class EstudianteTest extends TestCase
{
    ...
    #[Test]
    public function test_estudiante_pertenece_a_un_usuario()
    {
    ...
    #[Test]
    public function test_estudiante_pertenece_a_una_especialidad()
    {
    ...
    #[Test]
    public function test_estudiante_tiene_muchos_horarios_a_traves_de_horario_estudiantes()
    {
