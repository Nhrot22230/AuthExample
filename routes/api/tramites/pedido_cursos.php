...
Route::get('/especialidades/{especialidad}/cursos-pedido/{pedido}', [PedidoCursosController::class, 'getCursosPorEspecialidad']);
...
Route::get('/especialidades/{especialidadId}/cursos-electivos/{pedido}', [PedidoCursosController::class, 'getCursosElectivosPorEspecialidad']);
